...
#define __GMP_CFLAGS "-ggdb -O2 -pipe -Wimplicit-function-declaration -Wno-attributes -fdebug-prefix-map=/mnt/share/maint/gmp.x86/build=/usr/src/debug/gmp-6.1.0-3p1 -fdebug-prefix-map=/mnt/share/maint/gmp.x86/src/gmp-6.1.0=/usr/src/debug/gmp-6.1.0-3p1"
