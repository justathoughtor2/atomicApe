...
set terminal=%drive%\\atomicApe\\cygwin\\bin\\mintty.exe
...
"%home%\fnr.exe" --cl --dir "%preferencesDir%" --fileMask "*.js" --excludeFileMask "*.dll, *.exe" --useRegEx --find """terminalCommand"": { ""type"": ""string"", ""value"": "".*"" }," --replace """terminalCommand"": { ""type"": ""string"", ""value"": ""%terminal%"" },"
