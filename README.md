...
Before you start Brackets on a different PC than you have before, run the command `fixbrackets` to set up environment variables for the editor. After starting Brackets, open File > Git Settings and select Reset to Defaults. Then restart Brackets and your Git installation will be good to go in Brackets!
